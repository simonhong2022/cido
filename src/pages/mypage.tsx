  ...
  const projects = [
    {
      ...
      price: '64,300 won',
      image: 'https://www.figma.com/api/mcp/asset/5f3926a0-f55d-47b4-af1d-27670d5b5aec',
    },
    {
      id: 2,
      title: '박환 공간',
      category: 'illustration, Book Design',
      price: '24,000 won',
      image: 'https://www.figma.com/api/mcp/asset/aae39427-f2b1-426f-a5aa-842b7a1c0217',
    },
    {
      id: 3,
      title: '무제',
      category: 'illustration, Book Design',
      price: '36,000 won',
      image: 'https://www.figma.com/api/mcp/asset/15c46525-9839-4c67-9e56-65cdf909eba3',
    },
    {
      id: 4,
      title: 'Piercing & Body Modification',
  ...
  const portfolios = [
    {
      ...
      category: 'Enterprise',
      image: 'https://www.figma.com/api/mcp/asset/d47765ce-2ac7-4e7e-96a6-eec3eb6d9540',
    },
    {
      id: 2,
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.profileHeader}>
          ...
          <div className={styles.profileInfo}>
            ...
            <p className={styles.profileBio}>
              트렌드와 국내 현실에 맞닿은 2030 세대의 트렌드, 문화 생활상을 담은 2D 일러스트와 영상 작업을 진행하고 있습니다. 
              비주얼 작업 외에 세계관 안팎으로 젊은 세대가 겪는 불안과 문제점을 대표하는 캐릭터를 설정하여 진행되는 스토리텔링 작업도 진행하고 있습니다
            </p>
          </div>
        ...
        <div className={styles.tabs}>
          ...
          <button
            className={`${styles.tab} ${activeTab === 'buyer' ? styles.activeTab : ''}`}
        ...
        {activeTab === 'seller' && isSeller && (
          <>
            ...
            <section className={styles.projectsSection}>
              <h2 className={styles.sectionTitle}>여명대학교 님의 프로젝트 상품</h2>
            ...
            <section className={styles.portfoliosSection}>
              <div className={styles.sectionHeader}>
                <h2 className={styles.sectionTitle}>시도와 함께한 포트폴리오</h2>
                ...
                {portfolios.map((portfolio) => (
                  <div key={portfolio.id} className={styles.portfolioCard}>
                    ...
                    <div className={styles.portfolioInfo}>
                      ...
                      <p className={styles.portfolioCategory}>{portfolio.category}</p>
        ...
        {activeTab === 'buyer' && (
          <>
            ...
            <section className={styles.buyerSection}>
              <h2 className={styles.sectionTitle}>Midjourney CEO님의 구매한 상품</h2>
            ...
            {/* Liked Jobs Section */}
            <section className={styles.buyerSection}>
              <h2 className={styles.sectionTitle}>미드저니 CEO님이 좋은 공고</h2>
                    ...
                    <div className={styles.jobInfo}>
                      ...
                      <div className={styles.jobTags}>
                        {job.tags.map((tag, idx) => (
                          <span key={idx} className={styles.jobTag}>{tag}</span>
                        ))}
                      </div>
                    </div>
                  </div>
