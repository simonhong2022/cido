...
const DesignersPage = () => {
  ...
  const hotDesigners = [
    { id: 1, image: 'https://www.figma.com/api/mcp/asset/f9510fd3-fa2b-481d-b100-2d03e6d21036' },
    { id: 2, image: 'https://www.figma.com/api/mcp/asset/f9510fd3-fa2b-481d-b100-2d03e6d21036' },
    { id: 3, image: 'https://www.figma.com/api/mcp/asset/f9510fd3-fa2b-481d-b100-2d03e6d21036' },
    { id: 4, image: 'https://www.figma.com/api/mcp/asset/f9510fd3-fa2b-481d-b100-2d03e6d21036' },
  ];
  ...
  const designers = Array.from({ length: 12 }, (_, i) => ({
    ...
    image: 'https://www.figma.com/api/mcp/asset/415542be-debd-470b-8525-7b90b22207a4',
  }));
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="만나보세요, 시도와 함께하는 디자이너들" />
      </Head>
