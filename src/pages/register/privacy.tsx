        ...
        <div className={styles.modal}>
          ...
          <div className={styles.list}>
            ...
            <label className={styles.row}>
              <input type="checkbox" checked={allChecked} onChange={toggleAll} className={styles.checkbox} />
            ...
            {/* 만 14세 이상입니다 */}
            <label className={styles.row}>
              <input type="checkbox" checked={over14} onChange={onChangeRequired(setOver14)} className={styles.checkbox} />
            ...
            {/* 이용약관 동의 */}
            <label className={styles.row}>
              <input type="checkbox" checked={tos} onChange={onChangeRequired(setTos)} className={styles.checkbox} />
            ...
            {/* 개인정보 수집, 이용 동의 */}
            <label className={styles.row}>
              <input type="checkbox" checked={privacy} onChange={onChangeRequired(setPrivacy)} className={styles.checkbox} />
            ...
            {/* 광고성 정보 수신동의 (선택) */}
            <label className={styles.row}>
              <input type="checkbox" checked={ads} onChange={onChangeOptional(setAds)} className={styles.checkbox} />
              <span className={styles.rowText}>광고성 정보 수신동의 (선택)</span>
              <button type="button" className={styles.viewBtn}>보기</button>
            </label>
          </div>

          <div className={styles.actions}>
            <button className={styles.cancelBtn} onClick={handleCancel}>취소하기</button>
            <button className={styles.agreeBtn} onClick={handleAgree} disabled={!requiredChecked}>동의하기</button>
          </div>
        </div>
      </main>
