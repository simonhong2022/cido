...
const CommunityPage = () => {
  ...
  // Mock data for Q&A
  const qaList = [
    { id: 1, title: '일러스트 작업 외주 금액 책정은 어떻게 해야할까요?', replies: 4 },
    { id: 2, title: '20살에 결혼하는 친구 축의금은 얼마나 내야할까?', replies: 4 },
    { id: 3, title: '내게 맞는 직무 정하는 방법!', replies: 4 },
    { id: 4, title: '디자인 대외활동 해야할까요?', replies: 4 },
    { id: 5, title: '현장실습은 인턴인가요?', replies: 4 },
    { id: 6, title: '일러스트 작업 외주 금액 책정은 어떻게 해야할까요?', replies: 4 },
    { id: 7, title: '20살에 결혼하는 친구 축의금은 얼마나 내야할까?', replies: 4 },
    { id: 8, title: '일러스트 작업 외주 금액 책정은 어떻게 해야할까요?', replies: 4 },
    { id: 9, title: '일러스트 작업 외주 금액 책정은 어떻게 해야할까요?', replies: 4 },
    { id: 10, title: '일러스트 작업 외주 금액 책정은 어떻게 해야할까요?', replies: 4 },
  ];
  ...
  const interviews = [
    {
      ...
      title: '인터뷰 제목',
      designer: '디자이너 이름',
      image: 'https://www.figma.com/api/mcp/asset/f9510fd3-fa2b-481d-b100-2d03e6d21036',
    },
    {
      id: 2,
      title: '인터뷰 제목',
    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.interviewSection}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>시도와 함께하는 디자이너 인터뷰</h2>
            <button className={styles.viewAllButton}>
              전체보기
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" />
            ...
            {interviews.map((interview) => (
              <div key={interview.id} className={styles.interviewCard}>
                ...
                <div className={styles.interviewInfo}>
                  ...
                  <p className={styles.interviewDesigner}>{interview.designer}</p>
                </div>
              </div>
            ))}
          </div>
              ...
              <div key={exhibition.id} className={styles.exhibitionCard}>
                ...
                <div className={styles.exhibitionInfo}>
                  ...
                  <div className={styles.exhibitionPrice}>
                    <span className={styles.discount}>{exhibition.discount}</span>
